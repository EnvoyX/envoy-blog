  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-transparent rounded-lg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-100 w-100 rounded-full bg-white/5 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mt-8 space-y-3 flex flex-col items-center">
          ...
          <div className="h-3 w-48 animate-pulse rounded-full bg-zinc-900" />
        </div>
