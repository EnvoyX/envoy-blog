          ...
          return !inline && match ? (
            <div className="group relative my-6 overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950">
              <div className="flex items-center justify-between px-4 py-2 bg-zinc-900/50 border-b border-zinc-800">
                <span className="text-xs font-mono text-zinc-500 uppercase">{match[1]}</span>
                <button
                  onClick={onCopy}
                  className="p-1.5 rounded-md hover:bg-zinc-800 transition-all text-zinc-400 hover:text-primary-400"
                >
