      ...
      <DialogContent className="sm:max-w-6xl p-0 overflow-hidden border-zinc-800 bg-zinc-950">
        <div className="flex flex-col md:flex-row h-full max-h-[90vh]">
            ...
            >
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-900/50 border border-zinc-800 transition-colors hover:border-primary/30">
                    <div className="space-y-0.5">
                      <Label className="text-sm font-medium text-zinc-200">
                        Visibility:{" "}
                        <span className={field.state.value ? "text-foreground" : "text-zinc-400"}>
                          ...
                          <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-900/50 border border-zinc-800 transition-colors hover:border-primary/30 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="space-y-0.5">
                              <Label className="text-sm font-medium text-zinc-200">
                                ...
                                <span
                                  className={
                                    field.state.value ? "text-foreground" : "text-zinc-400"
                                  }
                                >
                        ...
                        <div className="relative group">
                          <Textarea
                            ...
                            className={`
                                    ...
                                    focus-visible:ring-primary-500/40 focus-visible:border-primary-500/50
                          ...
                          <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-white/5 group-focus-within:ring-primary-500/10 transition-all" />
                        </div>
              ...
              <Tabs defaultValue="import-images" className="w-full">
                        ...
                        return (
                          <>
                                      ...
                                      <div className="flex flex-col gap-3 p-4 rounded-xl border border-zinc-800 bg-zinc-900/30 animate-in fade-in slide-in-from-left-2">
                                        ...
                                        <div className="space-y-1">
                                          <Input
                                            ...
                                            className="bg-zinc-950! border-zinc-800 focus-visible:ring-primary-500/50 h-9 text-sm"
                            ...
                            <Button
                              type="button"
                              variant="outline"
                              className="w-full border-dashed border-zinc-700 hover:border-primary-500/50 hover:bg-primary-500/5 transition-all text-zinc-400 hover:text-primary-400 py-6 cursor-pointer"
                              onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                                field.pushValue({
                ...
                <TabsContent value="add-gallery">
                          ...
                          <span
                            className={cn(
                              buttonVariants({
                                variant: "default",
                                className:
                                  "bg-primary-600 hover:bg-primary-500 text-white rounded-xl w-fit font-bold shadow-lg shadow-primary-900/20 animate-in fade-in zoom-in duration-300",
                              }),
                              {
                  ...
                  <div className="flex-1 p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-primary-400 scrollbar-track-primary-900 max-h-125 relative border-t-2 border-b-2 border-primary-400">
                    {isPending ? (
                ...
                <form.Subscribe
                  ...
                  children={([canSubmit, isSubmitting]) => (
                    <Button
                      ...
                      className="w-full bg-primary-600 hover:bg-primary-500 text-white font-bold h-12 rounded-xl transition-all shadow-lg shadow-primary-900/20 cursor-pointer"
                    >
          ...
          <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-[#09090b] relative overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary-500/10 blur-[120px] rounded-full" />
            <form.Subscribe
                ...
                return (
                  <div className="w-full max-w-lg px-12 relative z-10">
                    <Carousel className="w-full" setApi={setApi}>
                      ...
                      <CarouselPrevious className="-left-10  border-primary-600! text-primary-500 hover:text-primary-400 transition-colors cursor-pointer" />
                      <CarouselNext className="-right-10  border-primary-600! text-primary-500 hover:text-primary-400 transition-colors cursor-pointer" />
