        ...
        <div className="flex flex-col md:flex-row h-[85vh] ">
          <div className="w-full md:w-1/3 max-md:hidden p-8 border-r border-zinc-800/50 bg-zinc-900/20 flex flex-col">
            ...
            <div className="mt-auto pt-6 space-y-4">
              <div
                className={cn("p-4 rounded-xl bg-primary/5 border border-primary/10", {
              ...
              {selectedIds.size > 0 && (
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={cn(
                      "bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl px-2 font-bold shadow-lg shadow-primary/20 animate-in fade-in zoom-in duration-300 cursor-pointer",
                      {
