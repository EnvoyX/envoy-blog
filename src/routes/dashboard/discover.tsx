...
import { bulkScrapeUrl } from '@/data/items'
...
export const Route = createFileRoute('/dashboard/discover')({
    head: () => ({
        meta: [
            ...
            { property: 'og:description', content: "Discover the latest news and updates from Envoy Blog." },
        ...
        <div className="flex flex-1 items-center justify-center py-8">
            <div className="w-full max-w-2xl space-y-6 px-4">
                <div className="text-center">
                    ...
                    <p className='pt-2 text-muted-foreground'>Search the web articles for any topic you interested.</p>
                </div>
                <Card>
                    <CardHeader>
                                        ...
                                        return (
                                            <Label key={link.url} className="hover:bg-muted/50 flex cursor-pointer items-start gap-3 rounded-md p-2">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    {link.category && (
                                                        <Badge variant={"default"} className='my-1'>{link.category.toUpperCase()}</Badge>
                                                    )}
                                                </div>
                                            </Label>
                                        )
