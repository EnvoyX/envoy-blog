            ...
            <section className="relative pt-20 pb-32 px-8 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto">
                        This is my own TanStack Start playground to learn and experiment with. Powered by TanStack Router,
                        Vite, and server-side functions that feel like magic.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to='/login' className="flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 px-8 py-4 rounded-xl font-bold transition-all transform hover:scale-105">
                            Login <ArrowRight size={18} />
                        </Link>
                        <a href="https://github.com/EnvoyX/envoy-blog" target='_blank' className="flex items-center justify-center gap-2 bg-slate-900 border border-slate-800 hover:border-slate-700 px-8 py-4 rounded-xl font-bold transition-all">
